...
export function Projects(props) {
  ...
  return (
    <>
      ...
      <FadeExample image="https://github.com/paigelindahl/portfolio/blob/master/docs/dashboard1_iphonexrspacegrey_portrait.png?raw=true" title="UKIYO"wid="350" high="auto" text="A one stop wellness app intended to alleviate stress and promote positive feelings. Ukiyo provides a dashboard with access to meditation, yoga, gratitude journal and todo list organizer." language="React JS / Material UI / PSQL / Node / Express"/>
      <FadeExample image="https://github.com/paigelindahl/portfolio/blob/master/docs/homepage_macbookgrey_front.png?raw=true" title="PIZZERIA" wid="600" high="auto" text="Pizza pickup application, allowing users to order pizza online from a local pizza parlour. Admin are able to monitor orders and send an SMS using Twilio when orders are ready for pickup." language="JS / Bootstrap / PSQL / Node / Express"/>
