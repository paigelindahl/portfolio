...
export function Projects(props) {
  ...
  return (
    <>
      ...
      <FadeExample image="https://github.com/paigelindahl/portfolio/blob/master/docs/Tweeter-cropped.png?raw=true" title="TWEETER" wid="600" high="auto" text="Single page application Twitter clone." language="HTML / CSS / JS / jQuery / AJAX / Node / Express" />
